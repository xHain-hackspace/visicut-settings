 ...
 * Clone the repo to .visicut:
    ...
    ```bash
    git clone git@github.com:xHain-hackspace/visicut-settings.git .visicut
    ```
...
Because of frequent broken visicam settings, we do a daily `git checkout` for devices/Epilog_Zing_30_x-hain.xml to get fine visicam settings.
